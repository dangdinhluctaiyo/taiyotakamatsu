...
export const AIChat: React.FC<Props> = ({ refreshApp }) => {
    ...
    const quickActions = [
        { label: `📦 ${t('check_inventory')}`, prompt: t('check_inventory') },
        { label: `🔍 ${t('find_product')}`, prompt: t('find_product') },
    ];
                    ...
                    <div className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white p-4 flex items-center justify-between shrink-0">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-purple-200">{t('ai_support_desc')}</p>
                            </div>
                        </div>
                        <button
                                ...
                                >
                                    ...
                                    {msg.action && msg.action.requireConfirmation && msg.action.type !== 'none' && (
                                        <div className="mt-3 flex gap-2">
                                            ...
                                            >
                                                <CheckCircle className="w-4 h-4" /> {t('confirm_create_order')}
                                            </button>
                                            <button
